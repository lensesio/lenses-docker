...
OPTS_NEEDQUOTE="$OPTS_NEEDQUOTE LENSES_ALERT_MANAGER_SOURCE LENSES_KUBERNETES_PROCESSOR_JAAS LENSES_SECURITY_PASSWORD"
...
OPTS_SENSITIVE="$OPTS_SENSITIVE LENSES_SECURITY_PASSWORD"
